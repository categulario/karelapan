...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'usuarios_grupo', (
            ...
            ('descripcion', self.gf('django.db.models.fields.CharField')(max_length=240)),
            ('elegible', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'usuarios', ['Grupo'])

        # Adding model 'Olimpiada'
        db.create_table(u'usuarios_olimpiada', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('anio', self.gf('django.db.models.fields.IntegerField')(default=2013)),
            ('sede', self.gf('django.db.models.fields.CharField')(max_length=140, blank=True)),
        ))
        db.send_create_signal(u'usuarios', ['Olimpiada'])
        ...
        db.create_table(u'usuarios_perfil', (
            ...
            ('appat', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('apmat', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('estado', self.gf('django.db.models.fields.CharField')(default='veracruz', max_length=25)),
            ('sexo', self.gf('django.db.models.fields.CharField')(default='M', max_length=1)),
            ('subsistema', self.gf('django.db.models.fields.CharField')(default='OTROS', max_length=20)),
            ('nivel_estudios', self.gf('django.db.models.fields.CharField')(default='secundaria', max_length=20)),
            ('grado_actual', self.gf('django.db.models.fields.CharField')(default='2 bachillerato', max_length=20)),
            ('fecha_nacimiento', self.gf('django.db.models.fields.DateField')(null=True)),
            ('asesor', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='asesorados', null=True, to=orm['auth.User'])),
            ('nombre_escuela', self.gf('django.db.models.fields.CharField')(max_length='140', blank=True)),
            ('problemas_resueltos', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('puntaje', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('descripcion', self.gf('django.db.models.fields.TextField')()),
            ('ultima_omi', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['usuarios.Olimpiada'])),
            ('confirm_token', self.gf('django.db.models.fields.CharField')(max_length=36, null=True, blank=True)),
        ))
        db.send_create_signal(u'usuarios', ['Perfil'])

        # Adding M2M table for field grupos on 'Perfil'
        m2m_table_name = db.shorten_name(u'usuarios_perfil_grupos')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('perfil', models.ForeignKey(orm[u'usuarios.perfil'], null=False)),
            ('grupo', models.ForeignKey(orm[u'usuarios.grupo'], null=False))
        ))
        db.create_unique(m2m_table_name, ['perfil_id', 'grupo_id'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Olimpiada'
        db.delete_table(u'usuarios_olimpiada')

        # Deleting model 'Perfil'
        db.delete_table(u'usuarios_perfil')

        # Removing M2M table for field grupos on 'Perfil'
        db.delete_table(db.shorten_name(u'usuarios_perfil_grupos'))
