...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Aviso.contenido'
        db.alter_column(u'sitio_aviso', 'contenido', self.gf('tinymce.models.HTMLField')())

        # Changing field 'PreguntaFrecuente.respuesta'
        db.alter_column(u'sitio_preguntafrecuente', 'respuesta', self.gf('tinymce.models.HTMLField')())

    def backwards(self, orm):

        # Changing field 'Aviso.contenido'
        db.alter_column(u'sitio_aviso', 'contenido', self.gf('django.db.models.fields.TextField')())

        # Changing field 'PreguntaFrecuente.respuesta'
        db.alter_column(u'sitio_preguntafrecuente', 'respuesta', self.gf('django.db.models.fields.TextField')())
