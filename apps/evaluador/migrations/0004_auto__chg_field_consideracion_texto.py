...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Consideracion.texto'
        db.alter_column(u'evaluador_consideracion', 'texto', self.gf('django.db.models.fields.CharField')(max_length=300))

    def backwards(self, orm):

        # Changing field 'Consideracion.texto'
        db.alter_column(u'evaluador_consideracion', 'texto', self.gf('django.db.models.fields.CharField')(max_length=254))
