...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Concurso.autor'
        db.delete_column(u'evaluador_concurso', 'autor_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Concurso.autor'
        raise RuntimeError("Cannot reverse this migration. 'Concurso.autor' and its values cannot be restored.")
