...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Concurso.administradores'
        raise RuntimeError("Cannot reverse this migration. 'Concurso.administradores' and its values cannot be restored.")
