...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Concurso.administradores'
        db.add_column(u'evaluador_concurso', 'administradores',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', to=orm['auth.Group']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Concurso.administradores'
        db.delete_column(u'evaluador_concurso', 'administradores_id')
