...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'sitio_noticia', (
            ...
            ('pegajoso', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'sitio', ['Noticia'])

        # Adding model 'Aviso'
        db.create_table(u'sitio_aviso', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contenido', self.gf('django.db.models.fields.TextField')()),
            ('tipo', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('mostrado', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('caducidad', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'sitio', ['Aviso'])

        # Adding model 'PreguntaFrecuente'
        db.create_table(u'sitio_preguntafrecuente', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pregunta', self.gf('django.db.models.fields.CharField')(max_length=254)),
            ('respuesta', self.gf('django.db.models.fields.TextField')()),
            ('ordenacion', self.gf('django.db.models.fields.IntegerField')()),
            ('mostrado', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'sitio', ['PreguntaFrecuente'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'sitio_aviso')

        # Deleting model 'PreguntaFrecuente'
        db.delete_table(u'sitio_preguntafrecuente')
