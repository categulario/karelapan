...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Libro.portada'
        db.add_column(u'libro_libro', 'portada',
                      self.gf('django.db.models.fields.files.ImageField')(default='de', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Libro.portada'
        db.delete_column(u'libro_libro', 'portada')
    ...
    models = {
        ...
        u'libro.codigo': {
            ...
            'codigo': ('django.db.models.fields.CharField', [], {'default': "'99d04f3c-07cd-11e3-92a5-701a0416ad73'", 'max_length': '36'}),
