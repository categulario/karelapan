...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field inscripciones on 'Perfil'
        m2m_table_name = db.shorten_name(u'usuarios_perfil_inscripciones')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('perfil', models.ForeignKey(orm[u'usuarios.perfil'], null=False)),
            ('olimpiada', models.ForeignKey(orm[u'usuarios.olimpiada'], null=False))
        ))
        db.create_unique(m2m_table_name, ['perfil_id', 'olimpiada_id'])


    def backwards(self, orm):
        # Removing M2M table for field inscripciones on 'Perfil'
        db.delete_table(db.shorten_name(u'usuarios_perfil_inscripciones'))
    ...
    models = {
        ...
        u'usuarios.perfil': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inscripciones': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'inscritos'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['usuarios.Olimpiada']"}),
            ...
            'ultima_omi': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': u"orm['usuarios.Olimpiada']"}),
