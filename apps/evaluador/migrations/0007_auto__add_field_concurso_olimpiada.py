...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Concurso.olimpiada'
        db.add_column(u'evaluador_concurso', 'olimpiada',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['usuarios.Olimpiada'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Concurso.olimpiada'
        db.delete_column(u'evaluador_concurso', 'olimpiada_id')
