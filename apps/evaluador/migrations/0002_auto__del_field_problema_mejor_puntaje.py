...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Problema.mejor_puntaje'
        db.delete_column(u'evaluador_problema', 'mejor_puntaje')


    def backwards(self, orm):
        # Adding field 'Problema.mejor_puntaje'
        db.add_column(u'evaluador_problema', 'mejor_puntaje',
