...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Libro.costo'
        db.add_column(u'libro_libro', 'costo',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=7, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Libro.costo'
        db.delete_column(u'libro_libro', 'costo')
    ...
    models = {
        ...
        u'libro.codigo': {
            ...
            'codigo': ('django.db.models.fields.CharField', [], {'default': "'e233d2c8-07d0-11e3-baf1-701a0416ad73'", 'max_length': '36'}),
