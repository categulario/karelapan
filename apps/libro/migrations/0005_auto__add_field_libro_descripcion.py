...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Libro.descripcion'
        db.add_column(u'libro_libro', 'descripcion',
                      self.gf('tinymce.models.HTMLField')(default='verde'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Libro.descripcion'
        db.delete_column(u'libro_libro', 'descripcion')
    ...
    models = {
        ...
        u'libro.codigo': {
            ...
            'codigo': ('django.db.models.fields.CharField', [], {'default': "'76f7398c-07cb-11e3-b8c2-701a0416ad73'", 'max_length': '36'}),
