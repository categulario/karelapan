...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Concurso.importante'
        db.add_column(u'evaluador_concurso', 'importante',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Concurso.importante'
        db.delete_column(u'evaluador_concurso', 'importante')
    ...
    models = {
        ...
        u'evaluador.concurso': {
            ...
            'administradores': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': u"orm['auth.Group']"}),
            ...
            'grupos': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'concursos'", 'symmetrical': 'False', 'to': u"orm['usuarios.Grupo']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'importante': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '140'}),
            'olimpiada': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['usuarios.Olimpiada']", 'null': 'True', 'blank': 'True'}),
            'problemas': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['evaluador.Problema']", 'symmetrical': 'False', 'blank': 'True'}),
        ...
        u'evaluador.problema': {
            'Meta': {'ordering': "['nombre']", 'object_name': 'Problema'},
