...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field lectores on 'Libro'
        m2m_table_name = db.shorten_name(u'libro_libro_lectores')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('libro', models.ForeignKey(orm[u'libro.libro'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['libro_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field lectores on 'Libro'
        db.delete_table(db.shorten_name(u'libro_libro_lectores'))
    ...
    models = {
        ...
        u'libro.codigo': {
            ...
            'codigo': ('django.db.models.fields.CharField', [], {'default': "'8166a136-09b1-11e3-aede-701a0416ad73'", 'max_length': '36'}),
        ...
        u'libro.libro': {
            ...
            'costo': ('django.db.models.fields.DecimalField', [], {'max_digits': '7', 'decimal_places': '2'}),
            'descripcion': ('tinymce.models.HTMLField', [], {}),
            'grupo': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lectores': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
